...
$default = soft_blog_get_default_theme_options();

// Add Panel.
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Settings', 'soft-blog' ),
	'priority'   => 150,
...
$wp_customize->add_setting( 'theme_options[show_page_title]', array(
	...
	'sanitize_callback' => 'soft_blog_sanitize_select',
) );

$wp_customize->add_control( 'theme_options[show_page_title]', array(
	'label'              => esc_html__( 'Display Page Title', 'soft-blog' ),
...
$wp_customize->add_section('section_sidebar_layout', array(    
	'title'       => __('Sidebar Layout', 'soft-blog'),
	'panel'       => 'theme_option_panel'    
));
...
$wp_customize->add_control(new soft_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Blog Layout', 'soft-blog'),
...
$wp_customize->add_control(new soft_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Archive Layout', 'soft-blog'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_control(new soft_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Page Layout', 'soft-blog'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_control(new soft_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Single Post Layout', 'soft-blog'),
	'section' 	=> 'section_sidebar_layout',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Posts Content Length', 'soft-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[excerpt_length]', array(
	...
	'sanitize_callback' => 'soft_blog_sanitize_number_range',
) );
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => esc_html__( 'Content Length', 'soft-blog' ),
...
$wp_customize->add_setting( 'theme_options[your_latest_posts_title]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'soft_blog_sanitize_textarea_content',
	'transport'         => 'refresh',
	)
);
$wp_customize->add_control( 'theme_options[your_latest_posts_title]',
	array(
	'label'    => __( 'Blog Title', 'soft-blog' ),
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'soft-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'soft-blog' ),
...
$wp_customize->add_control( 'theme_options[show_header_image]', array(
	'label'              => esc_html__( 'Display Header Image', 'soft-blog' ),
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'theme_options[custom_theme_color]', array(
	'label'             => esc_html__( 'Custom Theme Color', 'soft-blog' ),
	'section'           => 'colors',
) ) );